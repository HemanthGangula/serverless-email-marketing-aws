...
def lambda_handler(event, context):
    ...
    bucket_name = 'sample-email-marketing'  # Replace with your bucket name
    ...
    try:
        ...
        email_template = s3_client.get_object(Bucket=bucket_name, Key='template.html') # Replace with your template name
        ...
        for contact in contacts:
            ...
            response = ses_client.send_email(
                Source='yourmail@gmail.com',  # Replace with your verified "From" address
                Destination={'ToAddresses': [contact['Email']]},
                Message={
                    'Subject': {'Data': 'Your Weekly Tech News Mail!', 'Charset': 'UTF-8'},
